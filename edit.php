        ...
        <div class="msg">
          ...
          <p>
            ...
            <form method="post" action="" class="form-horizontal" role="form">
            	<textarea name="tweet" cols="50" rows="5" class="form-control" placeholder="例：Hello World!"> <?php echo $tweet_view['tweet'] ?></textarea>
            	<input type="hidden" name="tweet_id" value="<?php echo $tweet_view['tweet_id']; ?>">
